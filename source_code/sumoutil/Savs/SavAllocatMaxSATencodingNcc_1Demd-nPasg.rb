...
def wcnfGenNcc(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)
...
if nofVar >= 2 * nofBus * (8 * 5) * (8 * 5) # note that the capacity is 8
...
for h in 0..allGridsArray.size-1
  for j in 0..allGridsArray[h].size-1
    for k in 0..allGridsArray[h][j].size-1
      ...
      if j == 0 && k == 0 && acceptedSizeArray[h] > 0 # && eachWeight < threshold
...
$externalityBuffer <<  "nofCarried #{nofCarried.join(" ")}\n";
...
#end
#$externalityBuffer << "\n";
$externalityBuffer <<  "pickDropArray #{pickDropArray.join(" ")}\n";
